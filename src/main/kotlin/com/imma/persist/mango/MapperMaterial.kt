...
data class MapperMaterial(
    ...
    fun toFactorName(propertyOrFactorName: String): String {
        return def.toFactorName(propertyOrFactorName)
    }
    ...
    fun toUpdates(updates: Updates): List<Document> {
        return updates.parts.map {
            ...
            val fieldName = toFactorName(factorName)
     ...
     */
    private fun fromFactorElement(element: FactorElement): String {
