...
class FactorElement : Element() {
	var factorIdOrName: String? = null
	var topicIdOrName: String? = null
	override fun toString(): String {
		return "FactorElement(factorIdOrName=$factorIdOrName, topicIdOrName=$topicIdOrName) ${super.toString()}"
	}
}
